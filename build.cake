...
var dockerRegistry = Argument("dockerRegistry", "secana");												// ./build.sh --target Build-Container -dockerRegistry="local"
var slnName = Argument("slnName", "RestFS");

Information(Figlet("RestFS"));
