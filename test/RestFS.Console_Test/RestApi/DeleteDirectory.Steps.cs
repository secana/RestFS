...
{
    public partial class DeleteDirectory : FeatureFixture
    {
        ...
        private void When_delete_on_directory_is_invoked()
        {
        ...
        private void Then_the_directory_is_deleted()
        {
            _storage.Verify(s => s.DeleteDirectory(_directory), Times.Once);
        }
    }
}